...
CREATE INDEX idx_merchants_created_at_desc ON merchants(created_at DESC NULLS LAST);

-- For ascending order (oldest first)
CREATE INDEX idx_merchants_created_at_asc ON merchants(created_at ASC NULLS LAST);
